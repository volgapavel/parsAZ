...
В этом режиме:
- [OK] Обработка текста работает
- [OK] Извлечение сущностей работает
- [OK] Извлечение отношений работает
- [OK] Классификация рисков работает
- [OK] Поиск персон работает (из индекса)
- [X] Сохранение в БД не работает
- [X] Статистика показывает mock данные
